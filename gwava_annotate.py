...
def encode_feats(vf, af):
    ...
    #df = DataFrame(intersection)
    #df.to_csv('Intersection.csv')

    #print len(intersection)
    #print len(intersection[0])
    #print intersection[0]
    #a12 = input(" Check temp files ")
    ...
    #df1 = df.T.fillna(0)
    #df1.to_csv('df_trial4.csv'
    print "exiting encode_feats"
